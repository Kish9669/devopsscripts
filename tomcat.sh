...
sed -i '58  a\<user username="tomcat" password="root123556" roles="manager-gui, manager-script"/>' apache-tomcat-10.1.36/conf/tomcat-users.xml
sed -i '59  a\</tomcat-users>' apache-tomcat-10.1.36/conf/tomcat-users.xml
